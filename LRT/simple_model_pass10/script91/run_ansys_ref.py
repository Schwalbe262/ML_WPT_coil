...
# Open aedt file
oDesktop.OpenProject("Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script91/ML_aedt/ML91.aedt")

# Make project
oProject = oDesktop.SetActiveProject("ML91")
...
oModule.ExportToFile("L Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script91/ML_data/inductance$VERSION_IDX_STR_dat.csv", False)
...
oModule.ExportToFile("Coupling Coeff Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script91/ML_data/coupling$VERSION_IDX_STR_dat.csv", False)
...
oModule.ExportToFile("Calculator Expressions Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script91/ML_data/loss$VERSION_IDX_STR_dat.csv", False)