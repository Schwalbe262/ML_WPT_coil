...
# Open aedt file
oDesktop.OpenProject("Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script11/ML_aedt/ML11.aedt")
...
oModule.ExportToFile("L Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script11/ML_data/inductance$VERSION_IDX_STR_dat.csv", False)
...
oModule.ExportToFile("Coupling Coeff Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script11/ML_data/coupling$VERSION_IDX_STR_dat.csv", False)
...
oModule.ExportToFile("Calculator Expressions Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model_pass10/script11/ML_data/loss$VERSION_IDX_STR_dat.csv", False)