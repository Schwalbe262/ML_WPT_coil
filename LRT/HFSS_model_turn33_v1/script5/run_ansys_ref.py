...
# Open aedt file
oDesktop.OpenProject("Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v1/script5/ML_aedt/ML5.aedt")
...
oModule.ExportToFile("Output Variables Table 1", "Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v1/script5/ML_data/inductance$VERSION_IDX_STR_dat.csv", False)


results = []
with open("Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v1/script5/ML_data/inductance$VERSION_IDX_STR_dat.csv") as csvfile:
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Calculator Expressions Table 1", "Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v1/script5/ML_data/loss$VERSION_IDX_STR_dat.csv", False)
