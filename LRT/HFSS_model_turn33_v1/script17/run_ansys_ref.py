...
# Open aedt file
oDesktop.OpenProject("Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v1/script17/ML_aedt/ML17.aedt")
...
results = []
with open("Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v1/script17/ML_data/inductance$VERSION_IDX_STR_dat.csv") as csvfile:
