...
# Open aedt file
oDesktop.OpenProject("Z:/git/ML_WPT_coil/LRT/simple_model/script44/ML_aedt/ML44.aedt")
...
oModule.ExportToFile("L Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model/script44/ML_data/inductance$VERSION_IDX_STR.csv", False)
...
oModule.ExportToFile("Coupling Coeff Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model/script44/ML_data/coupling$VERSION_IDX_STR.csv", False)
...
oModule.ExportToFile("Calculator Expressions Table 1", "Z:/git/ML_WPT_coil/LRT/simple_model/script44/ML_data/loss$VERSION_IDX_STR.csv", False)