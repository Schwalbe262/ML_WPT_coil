...
# Open aedt file
oDesktop.OpenProject("Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v2/script25/ML_aedt/ML25.aedt")
...
oModule.ExportToFile("Output Variables Table 1", "Y:/git/ML_WPT_coil/LRT/2/script25/ML_data/inductance$VERSION_IDX_STR_dat.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Calculator Expressions Table 1", "Y:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v2/script25/ML_data/loss$VERSION_IDX_STR_dat.csv", False)
