...
oProject.InsertDesign("HFSS", "HFSS_ML_v0", "DrivenTerminal", "") # check "HFSS_ML_v$VERSION_IDX_STR"
oDesign = oProject.SetActiveDesign("HFSS_ML_v0") # check "HFSS_ML_v$VERSION_IDX_STR"
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[20, 20] mm" # check [$coil_width0, $coil_width1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[3300, 1500] mm" # check [$length0, $length1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[400, 500] mm" # check [$width0, $width1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[10, 10] mm" # check [$coil_offset0, $coil_offset1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[50, 50] mm" # check [$turn_length_gap0, $turn_length_gap1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[30, 30] mm" # check [$turn_width_gap0, $turn_width_gap1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[24, 24] mm" # check [$ferrite_thick0, $ferrite_thick1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[60, 100] mm" # check [$ferrite_length_margin0, $ferrite_length_margin1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[60, 100] mm" # check [$ferrite_width_margin0, $ferrite_width_margin1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[50, 50] mm" # check [$ferrite_side_height0, $ferrite_side_height1] mm
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[30, 30] mm" # check [$ferrite_side_thick0, $ferrite_side_thick1] mm
				]
			]
		]
	])
...
oModule.ExportToFile("Output Variables Table 1", "Z:/git/ML_WPT_coil/LRT/HFSS_model_turn33_v1/script1/result_temp.csv", False)
