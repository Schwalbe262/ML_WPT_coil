...
def run_simul(version_idx_str):
    ...
    ferrite_thick0_range = [5, 30, 1, 0]
    ferrite_thick1_range = [5, 30, 1, 0]

    ferrite_height0_range = [5, 30, 1, 0]
    ferrite_height1_range = [5, 30, 1, 0]

    ferrite_ex0_range = [5, 30, 1, 0]
    ferrite_ex1_range = [5, 30, 1, 0]

    ferrite_margin0_range = [5, 50, 1, 0]
    ferrite_margin1_range = [5, 50, 1, 0]
    ...
    parameter = np.array([width0,width1,height0,height1,gap0,gap1,ferrite_thick0,ferrite_thick1,ferrite_ex0,ferrite_ex1,ferrite_margin0,ferrite_margin1])
    ...
    data1 = np.loadtxt(f'Z:\Autosimul_data\LRT\simple_model_turn22\{COMPUTER_NAME}\script11\inductance.csv', delimiter=",")
    new_data1 = np.vstack((data1, temp1))
    np.savetxt(f'Z:\Autosimul_data\LRT\simple_model_turn22\{COMPUTER_NAME}\script11\inductance.csv',new_data1,delimiter=",")

    data2 = np.loadtxt(f'Z:\Autosimul_data\LRT\simple_model_turn22\{COMPUTER_NAME}\script11\coupling.csv', delimiter=",")
    new_data2 = np.vstack((data2, temp2))
    np.savetxt(f'Z:\Autosimul_data\LRT\simple_model_turn22\{COMPUTER_NAME}\script11\coupling.csv',new_data2,delimiter=",")

    data3 = np.loadtxt(f'Z:\Autosimul_data\LRT\simple_model_turn22\{COMPUTER_NAME}\script11\loss.csv', delimiter=",")
    new_data3 = np.vstack((data3, temp3))
    np.savetxt(f'Z:\Autosimul_data\LRT\simple_model_turn22\{COMPUTER_NAME}\script11\loss.csv',new_data3,delimiter=",")
