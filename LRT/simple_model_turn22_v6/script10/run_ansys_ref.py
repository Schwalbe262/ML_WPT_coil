...
# Open aedt file
oDesktop.OpenProject("Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script10/ML_aedt/ML10.aedt")
...
oModule.ExportToFile("L Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script10/ML_data/inductance$VERSION_IDX_STR_dat.csv", False)
oModule.ExportToFile("Coupling Coeff Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script10/ML_data/coupling$VERSION_IDX_STR_dat.csv", False)
oModule.ExportToFile("Calculator Expressions Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script10/ML_data/loss$VERSION_IDX_STR_dat.csv", False)