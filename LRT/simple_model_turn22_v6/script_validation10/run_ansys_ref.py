...
# Open aedt file
oDesktop.OpenProject("Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation10/ML_aedt/ML_validation10.aedt")

# Make project
oProject = oDesktop.SetActiveProject("ML_validation10")
...
oEditor.CreateRegularPolygon(
	[
		...
		"ZCenter:="		, "-air_gap/2+1mm",
		"XStart:="		, "-1/2*width[0]",
		"YStart:="		, "(height[0]+height[1])/2",
		"ZStart:="		, "-air_gap/2+coil_width[0]/2+1mm",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Y"
	], 
	[
...
oEditor.CreateRegularPolygon(
	[
		...
		"YStart:="		, "-(height[0]+height[1])/2",
		"ZStart:="		, "air_gap/2-coil_width[1]/2-1mm",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Y"
	], 
	[
...
oModule.ExportToFile("L Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation10/ML_data/inductance$VERSION_IDX_STR_dat.csv", False)
oModule.ExportToFile("Coupling Coeff Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation10/ML_data/coupling$VERSION_IDX_STR_dat.csv", False)
oModule.ExportToFile("Calculator Expressions Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation10/ML_data/loss$VERSION_IDX_STR_dat.csv", False)