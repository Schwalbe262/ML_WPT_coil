...
# Open aedt file
oDesktop.OpenProject("Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation5/ML_aedt/ML_validation5.aedt")

# Make project
oProject = oDesktop.SetActiveProject("ML_validation5")
...
oModule.ExportToFile("L Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation5/ML_data/inductance$VERSION_IDX_STR_dat.csv", False)
oModule.ExportToFile("Coupling Coeff Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation5/ML_data/coupling$VERSION_IDX_STR_dat.csv", False)
oModule.ExportToFile("Calculator Expressions Table 1", "Y:/git/ML_WPT_coil/LRT/simple_model_turn22_v6/script_validation5/ML_data/loss$VERSION_IDX_STR_dat.csv", False)