	...
	[
		...
		[
			...
			[
				...
				"Y:="			, "-spacey*ratioy01-width*2+width/2",
				"Z:="			, "-2mm"
			],
			[
				"NAME:PLPoint",
				"X:="			, "spacex*ratiox02-w01/2",
				"Y:="			, "-spacey*ratioy01-width*2+width/2",
				"Z:="			, "0mm"
			]
		],
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "(spacex*ratiox01+width/2+spacex*ratiox02-w01/2)/2",
				"Y:="			, "(-spacey*ratioy01-width*2+width/2-spacey*ratioy01-width*2+width/2)/2",
				"Z:="			, "(-2mm+0mm)/2"
			],
			[
				"NAME:PLPoint",
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box,Ter1,Ter2,turn1"
	], 
	[
...
oModule.ExportOnGrid(address1+"\\data_temp\\Hfield1.fld", ["-127/128*magx", "-127/128*magy", "1mm"], ["127/128*magx", "127/128*magy", "10mm"], ["magx/64", "magy/64", "1mm"], "Setup1 : LastAdaptive", 
	...
	[
		...
		"N1:="			, "$N1",
		"Phase:="		, "0deg",
		"airx:="		, "spacex*ratiox02*2.5",
		"airy:="		, "spacey*ratioy01*3",
		"airz:="		, "50mm",
		"height:="		, "34.2um",
		"magx:="		, "spacex*ratiox01",
		"magy:="		, "spacey*ratioy01",
		"ratiox01:="		, "$ratiox01",
		"ratiox02:="		, "$ratiox02",
		"ratioy01:="		, "$ratioy01",
		"spacex:="		, "$spacexmm",
