	...
	[
		...
		[
			...
			[
				...
				"Y:="			, "-spacey*ratioy02-width*2+width/2",
				"Z:="			, "-2mm"
			],
			[
				"NAME:PLPoint",
				"X:="			, "spacex*ratiox03-w02/2",
				"Y:="			, "-spacey*ratioy02-width*2+width/2",
				"Z:="			, "0mm"
			]
		],
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "(spacex*ratiox01+width/2+spacex*ratiox03-w02/2)/2",
				"Y:="			, "(-spacey*ratioy02-width*2+width/2-spacey*ratioy02-width*2+width/2)/2",
				"Z:="			, "(-2mm+0mm)/2"
			],
			[
				"NAME:PLPoint",
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box,Ter1,Ter2,turn1,turn2"
	], 
	[
...
oModule.ExportOnGrid(address1+"\\data_temp\\Hfield1.fld", ["-127/128*magx", "-127/128*magy", "1mm"], ["127/128*magx", "127/128*magy", "10mm"], ["magx/64", "magy/64", "1mm"], "Setup1 : LastAdaptive", 
	...
	[
		...
		"N1:="			, "$N1",
		"Phase:="		, "0deg",
		"airx:="		, "spacex*ratiox03*2.5",
		"airy:="		, "spacey*ratioy02*3",
		"airz:="		, "50mm",
		"height:="		, "34.2um",
		"magx:="		, "spacex*ratiox02",
		"magy:="		, "spacey*ratioy02",
		"ratiox01:="		, "$ratiox01",
		"ratiox02:="		, "$ratiox02",
		"ratiox03:="		, "$ratiox03",
		"ratioy01:="		, "$ratioy01",
