	...
	[
		...
		[
			...
			[
				...
				"Y:="			, "-spacey*ratioy04-width*2+width/2",
				"Z:="			, "-2mm"
			],
			[
				"NAME:PLPoint",
				"X:="			, "spacex*ratiox05-w04/2",
				"Y:="			, "-spacey*ratioy04-width*2+width/2",
				"Z:="			, "0mm"
			]
		],
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "(spacex*ratiox01+width/2+spacex*ratiox05-w04/2)/2",
				"Y:="			, "(-spacey*ratioy04-width*2+width/2-spacey*ratioy04-width*2+width/2)/2",
				"Z:="			, "(-2mm+0mm)/2"
			],
			[
				"NAME:PLPoint",
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box,Ter1,Ter2,turn1,turn2,turn3,turn4"
	], 
	[
...
oModule.ExportOnGrid(address1+"\\data_temp\\Hfield1.fld", ["-127/128*magx", "-127/128*magy", "1mm"], ["127/128*magx", "127/128*magy", "10mm"], ["magx/64", "magy/64", "1mm"], "Setup1 : LastAdaptive", 
	...
	[
		...
		"N1:="			, "$N1",
		"Phase:="		, "0deg",
		"airx:="		, "spacex*ratiox05*2.5",
		"airy:="		, "spacey*ratioy04*3",
		"airz:="		, "50mm",
		"height:="		, "34.2um",
		"magx:="		, "spacex*ratiox04",
		"magy:="		, "spacey*ratioy04",
		"ratiox01:="		, "$ratiox01",
		"ratiox02:="		, "$ratiox02",
		"ratiox03:="		, "$ratiox03",
		"ratiox04:="		, "$ratiox04",
